...
import com.cy.vo.ShopInfo;
import com.cy.vo.ShopVo;
...
public class ShopActivity extends Activity {
	...
	private List<ShopVo> listmap=new ArrayList<ShopVo>();
	private String city;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		MainActivity.activityList.add(ShopActivity.this);
		listView = (ListView)findViewById(R.id.shopList);
		Intent intent=this.getIntent();
		city = intent.getStringExtra("city");
		ShopInfo shopInfo = new ShopInfo(this);
		listmap = shopInfo.getShopByCity(city);
		listView.postInvalidate();
		ListViewAdapter listViewAdapter = new ListViewAdapter(ShopActivity.this); 
