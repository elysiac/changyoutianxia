...
public class CityIntroActivity extends Activity {
	ListView cityList;
	CityInfo cityInfo;
	int index = 0;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		MainActivity.activityList.add(CityIntroActivity.this);
		setContentView(R.layout.activity_cityintro);
		...
		btn1.setOnClickListener(new android.view.View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				intent.setClass(CityIntroActivity.this, PlayActivity.class);
				CityIntroActivity.this.startActivity(intent);
			}
		});
		...
		cityList.setOnItemClickListener(new OnItemClickListener(){
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				String intro = cityVo.getCityintro();
	...
	private OnEditorActionListener onEditorActionListener = new OnEditorActionListener() {
		...
		public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
			...
			if(listcity.size()==0)
			{
				Toast.makeText(CityIntroActivity.this, "该城市不在当前省，请重新输入", Toast.LENGTH_LONG).show();//提示用户
				searchField.setText("");
			}
			else
			{
				cityList.postInvalidate();
				ListViewAdapter listViewAdapter = new ListViewAdapter(CityIntroActivity.this); 
				cityList.setAdapter(listViewAdapter);	
			}
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
 		...
 		if (keyCode == KeyEvent.KEYCODE_BACK) {
 			Intent intent = new Intent();
			intent.setClass(CityIntroActivity.this, GroupActivity.class);
			CityIntroActivity.this.startActivity(intent);
